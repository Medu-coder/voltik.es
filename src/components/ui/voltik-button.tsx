...
const voltikButtonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-base font-semibold transition-all duration-base ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        ghost: "text-foreground border border-muted-foreground/60 hover:border-muted-foreground hover:bg-accent hover:text-accent-foreground hover:-translate-y-0.5",
        voltik: "bg-primary text-primary-foreground font-bold hover:bg-primary/90 shadow-lg hover:shadow-2xl hover:-translate-y-0.5",
